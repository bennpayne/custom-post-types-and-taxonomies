...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <!-- Testing and Adding Additional Header for Review Post -->
    <?php if ( 'review' == get_post_type() ) {
        echo '<div class="review-header">Review</div>';
    }?>
	...
	<header class="entry-header clear">
		...
		<?php endif; ?>
        <!-- Testing for and Displaying Custom Post Types and Taxonomies -->
        <?php if ( 'review' == get_post_type() ) { ?>
